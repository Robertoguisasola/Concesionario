...
public class RegistrarCliente2 extends JFrame {
	...
	public RegistrarCliente2(Trabajador t) {
	...
	public static void abrirRegistrarCliente2(Trabajador t) {
		RegistrarCliente2 registrarCliente2 = new RegistrarCliente2(t);
		registrarCliente2.setTitle("Regístrate");
		registrarCliente2.setVisible(true);
		registrarCliente2.setSize(480,420);
		registrarCliente2.setLocationRelativeTo(null);
	}
}
