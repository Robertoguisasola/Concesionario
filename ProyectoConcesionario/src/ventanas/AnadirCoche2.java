...
public class AnadirCoche2 extends JFrame {
	...
	public AnadirCoche2(Trabajador t) {
		...
		agregarButton = new JButton("Añadir coche de segunda mano");
	...
	private void anadirCoche2(Trabajador t) {
		...
		int respuesta = JOptionPane.showOptionDialog( null, "¿Desea añadir otro nuevo coche de segunda mano?", "Añadir otro coche", JOptionPane.YES_NO_CANCEL_OPTION,
	...
	private boolean comprobarVacios() {
		...
		if (kilometrosField.getText().equals("")) {
			JOptionPane.showMessageDialog(this, "Por favor, introduzca los kilómetros del coche");
			return true;
		}
