...
public class ComprarCocheeeeeeeee extends JFrame {
	/**
	 * 
	 */
	...
	public ComprarCocheeeeeeeee(Persona p) {
		...
		//middlePanel.setLayout(new BoxLayout(gridPanel, BoxLayout.Y_AXIS));		
	...
	public static void abrirComprarCoche(Persona p) {
		ComprarCocheeeeeeeee ventanaCatalogoCoche = new ComprarCocheeeeeeeee(p);
